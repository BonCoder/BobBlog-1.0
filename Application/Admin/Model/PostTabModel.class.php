...
class PostTabModel extends Model
{
    protected $post;
    protected $patchValidate = true;

    protected $_validate = array(
        array('name', 'require', '标签名称不能够为空'),
    );
    ...
    public function getPageResult($wheres = array())
    {
        ...
        $pageHtml = '';
        $pageSize = 10;  // 每页多少条
        $totalRows = M("post_tab")->where($wheres)->count();  // 总条数
