                ...
                <div class="col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-3">
                                        <div class="">
                                            ...
                                            <a href="<?php echo U('PostCategory/lists');?>" class="btn btn-default">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <a href="<?php echo U('User/create');?>" class="btn btn-primary"><span
                                    class="glyphicon glyphicon-plus"></span> 新增</a>
                            <a href="javascript:;" class="js-delete btn btn-default">
                                <span class="glyphicon glyphicon-trash text-danger"></span>删除
                            </a>
                            <form id="js-delete-form" method="post" action="<?php echo U('User/delete');?>"
                                  style="display: none">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php if(is_array($users)): foreach($users as $key=>$user): ?><tr>
                                        <td class="text-center">
                                            <input class="ids" type="checkbox" value="<?php echo ($user["id"]); ?>">
                                        </td>
                                        <td class="text-center"><?php echo ($user["id"]); ?></td>
                                        <td class="text-center"><?php echo ($user["name"]); ?></td>
                                        <td class="text-center"><?php echo ($user["nickname"]); ?></td>
                                        <td class="text-center"><?php echo ($handleStatus[$user['status']]); ?></td>
                                        <td class="text-center"><?php echo ($user["last_time"]); ?></td>
                                        <td class="text-center"><?php echo ($user["last_ip"]); ?></td>
                                        <td class="text-center"><?php echo ($user["register_time"]); ?></td>
                                        <td class="text-center"><?php echo ($user["register_ip"]); ?></td>
                                        <td class="text-center">
                                            <a href="<?php echo U('User/create', array('id'=>$user['id']));?>"
