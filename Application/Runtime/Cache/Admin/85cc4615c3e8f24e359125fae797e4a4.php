    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('PostTab/lists');?>">文章管理</a></li>
        ...
        <section class="content">
            <div class="box box-primary">
                <form role="form" action="<?php echo U('PostTab/create');?>" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="inputName">标签名称</label>
                            <input type="text" name="tab_name" class="form-control" id="inputName" value="<?php echo ($tab_name); ?>">
                            ...
                            <!--<div class="input-group">-->
                                <!--<div class="input-group">-->
                                    ...
                                    <!--<input style="width: 100px; text-align: center;" type="text"-->
                                           <!--name="sort" value="<?php echo ($sort); ?>" class="form-control rate initialized"-->
                                           <!--placeholder="排序">-->
