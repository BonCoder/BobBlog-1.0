                ...
                <div class="col-xs-12">
                                    ...
                                    <form action="<?php echo U();?>" method="get">
                                        ...
                                        <div class="col-xs-3">
                                            <div class="">
                                                ...
                                                <a href="<?php echo U('VisitLog/ipLists');?>" class="btn btn-default">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <a href="<?php echo U('VisitLog/ipCreate');?>" class="btn btn-primary"><span
                                    class="glyphicon glyphicon-plus"></span> 新增</a>
                            <a href="javascript:;" class="js-delete btn btn-default">
                                <span class="glyphicon glyphicon-trash text-danger"></span> 删除
                            </a>
                            <form id="js-delete-form" method="post" action="<?php echo U('VisitLog/deleteIps');?>"
                                  style="display: none">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <?php if(is_array($shieldIps)): foreach($shieldIps as $key=>$shieldIp): ?><tr>
                                        <td class="text-center"><input class="ids" type="checkbox"
                                                                       value="<?php echo ($shieldIp["id"]); ?>"></td>
                                        <td class="text-center"><?php echo ($shieldIp["id"]); ?></td>
                                        <td class="text-center"><?php echo ($shieldIp["ip"]); ?></td>
                                        <td class="text-center"><?php echo ($shieldIp["remark"]); ?></td>
                                        <td class="text-center"><?php echo ($shieldIp["created_at"]); ?></td>
                                        <td class="text-center">
                                            <a data-id="<?php echo ($shieldIp["id"]); ?>"
    ...
    <script>
        ...
        function addMarker(data) {
            marker = new AMap.Marker({
                icon: "/Public/Admin/images/map.png",
                position: data
            });
            map.clearMap();
            marker.setMap(map);
