...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <form action="<?php echo U('Friend/examine');?>" method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-3">
                                        <div class="">
                                            ...
                                            <a href="<?php echo U('Friend/examine');?>" class="btn btn-default">
                    ...
                    <div class="box">
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="col-md-1 text-center">友链名</th>
                                    <th class="col-md-2 text-center">网址</th>
                                ...
                                <?php if(is_array($line)): foreach($line as $key=>$line): ?><tr>
                                        <td class="text-center"><input class="ids" type="checkbox"
                                                                       value="<?php echo ($line["id"]); ?>"></td>
                                        <td class="text-center"><?php echo ($line["id"]); ?></td>
                                        <td class="text-center"><?php echo ($line["name"]); ?></td>
                                        <td class="text-center"><a href="<?php echo ($line["website"]); ?>" target="view_window"><?php echo ($line["website"]); ?></a></td>
                                        <td class="text-center"><?php echo ($line["email"]); ?></td>
                                        <td class="text-center"><?php echo ($line["created_at"]); ?></td>
                                        <td class="text-center"><?php echo ($line["ip"]); ?></td>
                                        <td class="text-center">
                                            <a href="<?php echo U('Friend/ExamineAdd', array('id'=>$line['id']));?>"
                                               class="glyphicon glyphicon-pencil operation" title="通过审核">
                                            </a>
                                            <a data-id="<?php echo ($line["id"]); ?>"
                        ...
                        <div class="box-header">
                            ...
                            <form id="js-delete-form" method="post" action="<?php echo U('Friend/ExamineDelete');?>"
                                  style="display: none">
