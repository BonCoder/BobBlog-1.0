...
<head>
    ...
    <title>Bob的博客-个人博客-技术博客-PHP-Java-网站建设</title>
    ...
    <link rel="stylesheet" href="/Public/Home/css/main.css?1"/>
...
<div id="wrapper" style="position: absolute">
    ...
    <header id="header">
        <div class="logo">
            <img src="/Public/Home/images/logo3.png" height="100%" width="100%">
        </div>
        <div class="content">
            <div class="inner">
                <h1 class="homefont">Bob</h1>
                <p style="text-transform:none;letter-spacing: 0.1rem;">A Web Developer</p>
            </div>
        </div>
        <nav>
            <ul>
                <li><a href="<?php echo U('Post/index',array('id'=>-1));?>">博客</a></li>
    ...
    <footer id="footer">
        <p class="self ">
        <div style="font-size: 30px">迷茫是因為能力还配不上梦想！</div><br><br><br><br>
        </p>
    </footer>
    <!-- Main -->
    <div id="main">
        ...
        <article id="contact">
            <p align="center" style="color: white;">
                <img style="margin-bottom: 20px;" src="/Public/Home/images/logo3.png"><br>
                <span>ID：<code>Bob</code></span><br>
                <span>QQ：<code>44785355</code></span>
            </p>
        </article>
    </div>
...
<script src="/Public/Home/js/skel.min.js"></script>
<script src="/Public/Home/js/util.js"></script>
<script src="/Public/Home/js/main.js"></script>
<script>
    var hei=$(document).height();
    $("#jsi-snow-container").height(hei);
    var RENDERER = {
...
//            this.canvas = $('<canvas />').attr({width : this.width, height : this.height}).appendTo(this.$container).get(0);
            this.canvas = $('<canvas />').attr({width : this.width, height : hei}).appendTo(this.$container).get(0);
