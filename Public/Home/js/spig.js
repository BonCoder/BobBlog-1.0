...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br />    <a href=\"http://www.bobcoder.cc\" title=\"首页\">首页</a>    <a href=\"http://www.bobcoder.cc/Post/index/id/-1.html\" title=\"文章\">文章</a>    <a href=\"http://www.bobcoder.cc/admin\" title=\"后台\">后台</a> ",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到Bob阅读 ' + title + ' ', 6000);
    }
    $(".spig").animate({
