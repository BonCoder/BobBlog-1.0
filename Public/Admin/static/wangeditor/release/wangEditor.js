...
var doge = [];
for (var i=1;i<=17;i++){
    doge.push(" {alt: '["+i+"]',src: '/Public/Admin/emj/dog/"+i+".jpg'}")
}
var doges = doge.toString();


var config = {

    // 默认菜单配置
    menus: ['head', 'bold', 'italic', 'underline', 'strikeThrough', 'foreColor', 'backColor', 'link', 'list', 'justify', 'quote', 'emoticon', 'image', 'table', 'video', 'code', 'undo', 'redo','line'],
    ...
    emotions: [{
        ...
        type: 'doge',
        // content -> 数组
        content:[{src: '/Public/Admin/emj/dog/1.jpg', alt: '[1]'},{src: '/Public/Admin/emj/dog/2.jpg', alt: '[2]'},{src: '/Public/Admin/emj/dog/3.jpg', alt: '[3]'},{src: '/Public/Admin/emj/dog/4.jpg', alt: '[4]'},{src: '/Public/Admin/emj/dog/5.jpg', alt: '[5]'},{src: '/Public/Admin/emj/dog/6.jpg', alt: '[6]'},{src: '/Public/Admin/emj/dog/7.jpg', alt: '[7]'},{src: '/Public/Admin/emj/dog/8.jpg', alt: '[8]'},{src: '/Public/Admin/emj/dog/9.jpg', alt: '[9]'},{src: '/Public/Admin/emj/dog/10.jpg', alt: '[10]'},{src: '/Public/Admin/emj/dog/11.jpg', alt: '[11]'},{src: '/Public/Admin/emj/dog/12.jpg', alt: '[12]'},{src: '/Public/Admin/emj/dog/13.jpg', alt: '[13]'},{src: '/Public/Admin/emj/dog/14.jpg', alt: '[14]'},{src: '/Public/Admin/emj/dog/15.jpg', alt: '[15]'},{src: '/Public/Admin/emj/dog/16.jpg', alt: '[16]'},{src: '/Public/Admin/emj/dog/17.jpg', alt: '[17]'}]
    },{
        // tab 的标题
        title: '大黄脸',
        // type -> 'emoji' / 'image'
        type: 'face',
        // content -> 数组
        content:[{src: '/Public/Admin/emj/face/1.gif', alt: '[1]'},{src: '/Public/Admin/emj/face/2.gif', alt: '[2]'},{src: '/Public/Admin/emj/face/3.gif', alt: '[3]'},{src: '/Public/Admin/emj/face/4.gif', alt: '[4]'},{src: '/Public/Admin/emj/face/5.gif', alt: '[5]'},{src: '/Public/Admin/emj/face/6.gif', alt: '[6]'},{src: '/Public/Admin/emj/face/7.gif', alt: '[7]'},{src: '/Public/Admin/emj/face/8.gif', alt: '[8]'},{src: '/Public/Admin/emj/face/9.gif', alt: '[9]'},{src: '/Public/Admin/emj/face/10.gif', alt: '[10]'},{src: '/Public/Admin/emj/face/11.gif', alt: '[11]'},{src: '/Public/Admin/emj/face/12.gif', alt: '[12]'},{src: '/Public/Admin/emj/face/13.gif', alt: '[13]'},{src: '/Public/Admin/emj/face/14.gif', alt: '[14]'},{src: '/Public/Admin/emj/face/15.gif', alt: '[15]'}]
    }],
    ...
    Segmenting : [{
        ...
        type: 'line',
        // content -> 数组
        content:[{src: '/Public/Admin/emj/line/1.gif', alt: '[1]'},{src: '/Public/Admin/emj/line/2.gif', alt: '[2]'},{src: '/Public/Admin/emj/line/3.gif', alt: '[3]'},{src: '/Public/Admin/emj/line/4.gif', alt: '[4]'},{src: '/Public/Admin/emj/line/5.gif', alt: '[5]'},{src: '/Public/Admin/emj/line/6.gif', alt: '[6]'},{src: '/Public/Admin/emj/line/7.gif', alt: '[7]'},{src: '/Public/Admin/emj/line/8.gif', alt: '[8]'},{src: '/Public/Admin/emj/line/9.gif', alt: '[9]'},{src: '/Public/Admin/emj/line/10.gif', alt: '[10]'},{src: '/Public/Admin/emj/line/11.gif', alt: '[11]'},{src: '/Public/Admin/emj/line/12.gif', alt: '[12]'},{src: '/Public/Admin/emj/line/13.gif', alt: '[13]'},{src: '/Public/Admin/emj/line/14.gif', alt: '[14]'},{src: '/Public/Admin/emj/line/15.gif', alt: '[15]'}]
    }],
        ...
        emotions.forEach(function (emotData) {
            ...
            if (emotType === 'doge') {
                content.forEach(function (item) {
                    ...
                    if (src) {
                        // 加一个 data-w-e 属性，点击图片的时候不再提示编辑图片
                        document.styleSheets[0].addRule('.w-e-item .doge', 'width: 45px');
                        faceHtml += '<span class="w-e-item"><img class="doge" src="' + src + '" alt="' + alt + '" data-w-e="1"/></span>';
                    }
                });
            }
            // 大黄脸
            if (emotType === 'face') {
                content.forEach(function (item) {
                    ...
                    if (src) {
                        // 加一个 data-w-e 属性，点击图片的时候不再提示编辑图片
                        document.styleSheets[0].addRule('.w-e-item .face', 'width: 46px');
                        faceHtml += '<span class="w-e-item"><img class="face" src="' + src + '" alt="' + alt + '" data-w-e="1"/></span>';
                    }
                });
            }
...
Line.prototype = {
    ...
    _createPanel: function _createPanel() {
        ...
        var config = editor.config;
        // 获取表情配置
        var segmenting = config.Segmenting  || [];

        // 创建表情 dropPanel 的配置
        var tabConfig = [];
        segmenting.forEach(function (emotData) {
            var emotType = emotData.type;
            var content = emotData.content || [];
            ...
            if (emotType === 'line') {
                content.forEach(function (item) {
                    ...
                    if (src) {
                        // 加一个 data-w-e 属性，点击图片的时候不再提示编辑图片
                        document.styleSheets[0].addRule('.w-e-item .line', 'width: 250px');
                        faceHtml += '<span class="w-e-item"><img class="line" src="' + src + '" alt="' + alt + '" data-w-e="1"/></span>';
                    }
                });
            }
